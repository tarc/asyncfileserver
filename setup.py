...
setup(
    ...
    description="File Server",  # Optional
    ...
    # above.
    author_email="tarcisio.genaro@gmail.com",  # Optional
    ...
    install_requires=["exitstatus", "aiofiles", "aioconsole", "env"],  # Optional
